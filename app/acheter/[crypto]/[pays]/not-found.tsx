 ...
 *
 * Cas couvert : crypto inconnue ou pays hors liste FR-speaking
 * (FR, BE, CH, LU, MC, CA-FR) — ex. /acheter/foo/us.
 *
...
export default function AcheterNotFound() {
  return (
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-bold text-fg">
            Ce guide d'achat n'est pas (encore) disponible
          </h2>

          <p className="mt-4 max-w-xl mx-auto text-base text-fg/70">
            On explique comment acheter les principales cryptos depuis les pays
            francophones (France, Belgique, Suisse, Luxembourg, Monaco, Canada).
            Si cette page n'existe pas, c'est que la crypto ou le pays demandé
            sort de notre périmètre.
          </p>
          ...
          >
            <label htmlFor="acheter-search" className="sr-only">
