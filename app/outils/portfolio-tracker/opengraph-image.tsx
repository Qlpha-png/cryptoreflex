...
export const alt = "Portfolio Tracker crypto — suivi multi-coins en EUR temps réel";
    ...
    (
      <div
        style={{
          ...
          padding: 70,
          background:
            "radial-gradient(ellipse at 15% 10%, #0a2540 0%, transparent 60%), radial-gradient(ellipse at 85% 90%, #2a1f0a 0%, transparent 50%), #05060A",
          color: "white",
      ...
      >
        ...
        >
          ...
          >
            Multi-coins • Prix EUR live • Variation 24 h • Export CSV
          </div>
        </div>
