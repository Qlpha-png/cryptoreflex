...
/**
 * not-found.tsx co-localisé au segment /convertisseur/[pair].
 *
 ...
 *
 * Cas couvert : paire de conversion invalide (ex. /convertisseur/foo-bar,
 * actif hors COIN_IDS / FIAT_CODES, ou from === to).
 *
...
export default function ConvertisseurNotFound() {
  return (
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-bold text-fg">
            Cette paire de conversion n'est pas disponible
          </h2>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link href="/convertisseur" className="btn-primary text-base">
              <ArrowRightLeft className="h-4 w-4" />
              Le convertisseur crypto
            </Link>
            <Link
              href="/"
