 ...
 *
 * L'ancien plan « Cryptoreflex Soutien / Pro » payant (Stripe, abonnement
 * mensuel/annuel, IA Q&A gatée) n'existe plus : tout le site est désormais
 * 100 % gratuit. On conserve la route /pro (au lieu d'un 404) pour préserver
 * le SEO et expliquer le changement, et on redirige les visiteurs vers la
 * page de soutien libre (/soutenir) et les outils gratuits (/outils).
 *
 * Plus aucun prix, aucun lien Stripe, aucun composant de pricing/checkout ici.
 */

export const metadata: Metadata = {
  title: { absolute: "Cryptoreflex est désormais 100 % gratuit" },
  description:
    "L'ancien plan Pro payant n'existe plus : portfolio étendu, alertes, watchlist et tous les outils sont gratuits pour tout le monde. Soutien libre et facultatif.",
  alternates: withHreflang(`${BRAND.url}/pro`),
  openGraph: {
    title: "Cryptoreflex est désormais 100 % gratuit",
    description:
      "Le plan Pro payant a disparu : tout est gratuit pour tout le monde. Soutien libre et facultatif.",
    url: `${BRAND.url}/pro`,
    siteName: BRAND.name,
    locale: "fr_FR",
    type: "website",
  ...
  twitter: {
    ...
    title: "Cryptoreflex est désormais 100 % gratuit",
    description: "Le plan Pro payant a disparu : tout est gratuit pour tout le monde.",
...
const NOW_FREE = [
  { Icon: Wallet, label: "Portfolio étendu (positions, P&L, allocation)" },
  { Icon: Bell, label: "Alertes prix par email" },
  { Icon: ShieldCheck, label: "Watchlist étendue" },
  { Icon: BookOpen, label: "Tous les outils, calculateurs et guides" },
];
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-6 text-base sm:text-lg text-fg/80 max-w-2xl leading-relaxed">
              Cryptoreflex n&apos;a plus d&apos;abonnement payant. Ce qui était autrefois
              réservé au plan Soutien — portfolio étendu, alertes, watchlist, outils
              premium — est désormais ouvert à tout le monde, gratuitement. Aucune carte
              bancaire, aucun paiement.
            </p>
            ...
            <p className="mt-8 text-xs text-muted max-w-lg">
              Vous aviez un abonnement Soutien&nbsp;? Il n&apos;y a plus rien à payer.
