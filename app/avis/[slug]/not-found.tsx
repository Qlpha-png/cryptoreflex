...
/**
 * BUG FIX 2026-05-09 — `/avis/[bad-slug]` retournait HTTP 200 avec page
 * 404 héritée du layout. Co-localisation ici pour ancrer la 404 (HTTP 404
 * propre, Next 14+).
 */
...
export default function AvisNotFound() {
  return (
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-bold text-fg">
            On n'a pas (encore) d'avis sur cette plateforme
          </h2>
          ...
          >
            <label htmlFor="avis-search" className="sr-only">
