...
import { ArrowLeft, Search, GitCompareArrows } from "lucide-react";

/**
 * not-found.tsx co-localisé au segment /comparer/[slug].
 *
 * /comparer/[slug] redirige (301) vers /vs/[a]/[b] pour les slugs valides ;
 * notFound() n'est appelé que pour un slug invalide (format non reconnu).
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-bold text-fg">
            Ce comparatif n'est pas (encore) disponible
          </h2>
          ...
          >
            <label htmlFor="comparer-search" className="sr-only">
            ...
            <div className="relative">
              ...
              <input
                ...
                name="q"
                type="search"
                placeholder="Rechercher une plateforme (Binance, Coinbase…)"
                autoComplete="off"
