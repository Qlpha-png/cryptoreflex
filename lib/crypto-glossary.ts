...
export const CRYPTO_GLOSSARY: Record<string, GlossaryTerm> = {
  ...
  "staking": {
    term: "Staking",
    short: "Verrouiller vos cryptos pour aider à sécuriser une blockchain, en échange vous recevez des intérêts (comme un livret d'épargne).",
    full: "Le staking consiste à immobiliser ses cryptos (ETH, SOL, ADA…) dans le réseau pour valider les transactions. En échange, vous recevez des récompenses (3 à 8% par an typiquement). Risque : si vous validez mal, vous perdez une partie (slashing). Période de retrait variable (de quelques jours à plusieurs semaines).",
    alias: ["staker"],
    category: "concept",
  },
  "halving": {
  ...
  "wallet": {
    term: "Wallet",
    short: "Un porte-monnaie numérique pour stocker vos cryptos. Hardware = clé USB blindée, software = app.",
    full: "Un wallet stocke vos clés privées (le mot de passe qui prouve que les cryptos sont à vous). Wallet « custodial » = quelqu'un d'autre garde vos clés (ex : exchange). Wallet « non-custodial » = vous gardez vos clés (MetaMask, Phantom, Ledger). Règle d'or : « not your keys, not your coins ».",
  ...
  "seed phrase": {
    term: "Seed phrase",
    short: "12 ou 24 mots qui sont la sauvegarde maître de votre wallet. Si vous les perdez, vos cryptos sont perdues à jamais.",
    full: "La seed phrase (ou « phrase de récupération ») est générée par votre wallet à la création. Elle permet de récupérer toutes vos cryptos sur n'importe quel autre wallet compatible. Règles absolues : (1) écrire sur papier ou métal, JAMAIS en photo/cloud, (2) ne jamais la taper sur un site web, (3) ne jamais la donner à personne.",
  ...
  "spot": {
    term: "Spot",
    short: "Acheter une vraie crypto au prix actuel, livrée immédiatement dans votre wallet (par opposition aux futures/options).",
  ...
  "NFT": {
    term: "NFT",
    short: "Un certificat numérique unique stocké sur blockchain, qui prouve que vous possédez un objet digital (image, musique, ticket).",
