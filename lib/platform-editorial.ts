...
export const PLATFORM_EDITORIAL: Record<string, PlatformEditorial> = {
  ...
  coinbase: {
    ...
    verdict:
      "Coinbase est notre choix par défaut pour tout débutant français qui veut investir sereinement entre 100 € et 10 000 € en crypto et qui valorise plus la conformité réglementaire que les frais minimisés. La plateforme coche toutes les cases qui rassurent un primo-investisseur : société cotée NASDAQ, agrément MiCA, support en français, interface impeccable, assurance hot wallet. Si votre profil est davantage celui d'un trader actif ou si vous cherchez à minimiser les frais sur des montants importants, Binance, Kraken Pro ou Bitget seront plus pertinents. Pour empiler du BTC et de l'ETH chaque mois en mode DCA tranquille : Coinbase reste imbattable en 2026.",
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          "Oui, obligatoirement. Tout compte ouvert à l'étranger (Coinbase Europe est domiciliée en Irlande) doit être déclaré chaque année via le formulaire 3916-bis joint à votre déclaration de revenus. L'oubli est sanctionné par une amende forfaitaire de 750 € par compte non déclaré (1 500 € si solde > 50 000 €).",
      },
      {
  ...
  binance: {
    intro: [
      "Binance est, depuis 2020, le plus grand exchange crypto au monde en volume de trading spot et dérivés. Pour les utilisateurs français, le statut réglementaire reste un point d'attention : Binance France SAS est enregistrée PSAN auprès de l'AMF (E2022-037, depuis mai 2022), mais son agrément MiCA (CASP) n'est PAS encore délivré à mi-2026 — le dossier est en cours d'instruction (AMF / Luxembourg). Les prestataires doivent l'obtenir avant le 30 juin 2026 pour continuer à servir les clients de l'UE. Binance reste utilisable en France via son statut PSAN, mais suivez l'évolution de son agrément CASP.",
    ...
    micaProse:
      "Binance France SAS est enregistrée auprès de l'AMF sous le numéro PSAN E2022-037 depuis le 4 mai 2022 (consultable sur regafi.fr). En revanche, son agrément MiCA (CASP) n'a PAS encore été obtenu à mi-2026 : la demande est en cours d'instruction (AMF / Luxembourg), à recouper avec le registre ESMA officiel. Les prestataires doivent obtenir cet agrément avant le 30 juin 2026 pour continuer à servir les clients de l'UE. Le risque réglementaire n'est donc pas entièrement levé tant que l'agrément CASP n'est pas délivré.",
    paymentProse:
    ...
    verdict:
      "Binance est notre choix de référence en 2026 pour le trader intermédiaire à avancé français qui priorise les frais bas et la profondeur de marché. Son statut PSAN encadre son activité en France, mais l'agrément MiCA (CASP) reste à obtenir (échéance 30 juin 2026) : le risque réglementaire n'est pas entièrement levé. À éviter pour un débutant total qui n'a jamais utilisé d'exchange : la courbe d'apprentissage est réelle. Pour un investisseur qui sait ce qu'il fait et qui trade au moins 1 000 €/mois en volume cumulé, l'économie de frais par rapport à Coinbase ou Bitpanda dépasse facilement 200 €/an.",
    faq: [
      {
        question: "Binance est-elle légale en France en 2026 ?",
        answer:
          "Oui, via son statut PSAN AMF (E2022-037, mai 2022). En revanche son agrément MiCA (CASP) n'est pas encore délivré à mi-2026 : le dossier est en cours d'instruction (échéance 30 juin 2026). Les services spot, Earn et Convert restent accessibles aux résidents français ; surveillez l'obtention de l'agrément CASP.",
      },
      {
