...
export const PLATFORM_EDITORIAL: Record<string, PlatformEditorial> = {
  ...
  coinbase: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Oui, obligatoirement. Tout compte ouvert à l'étranger (Coinbase Europe est domiciliée en Irlande) doit être déclaré chaque année via le formulaire 3916-bis joint à votre déclaration de revenus. L'oubli est sanctionné par une amende forfaitaire de 1 500 € par compte non déclaré.",
      },
      {
  ...
  binance: {
    intro: [
      "Binance est, depuis 2020, le plus grand exchange crypto au monde en volume de trading spot et dérivés. Pour les utilisateurs français, l'année 2025 a marqué un tournant majeur : Binance France a obtenu son agrément MiCA via le passeporting européen (registre AMF E2022-037), ce qui a clarifié son statut après plusieurs années d'ambiguïté réglementaire. Concrètement, vous pouvez aujourd'hui utiliser Binance en France en toute légalité, avec un service en français et un support local.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Binance France étant immatriculée en France, le compte n'a théoriquement pas à être déclaré au formulaire 3916-bis. En pratique, par prudence, déclarez tout compte sur lequel vous détenez des cryptos. Les plus-values de cession sont à reporter sur le formulaire 2086, taxées à 30 % flat tax.",
      },
    ],
    related: RELATED_DEFAULT,
  },
  ...
  bitget: {
    ...
    faq: [
      ...
      {
        question: "Comment fonctionne le bonus de bienvenue Bitget jusqu'à 6200 USDT ?",
        answer:
          "Le bonus est progressif et débloqué par paliers de dépôt et de volume de trading. Concrètement, atteindre 6200 USDT nécessite plusieurs milliers d'euros de dépôt cumulé et plusieurs dizaines de milliers d'euros de volume de trading. Les premiers paliers (50 USDT, 100 USDT) sont accessibles avec des montants raisonnables. Lisez attentivement les conditions avant de viser le palier maximum.",
      },
      {
  ...
  "trade-republic": {
    ...
    paymentProse:
      "Trade Republic accepte le SEPA classique, le SEPA Instant (recommandé), Apple Pay et Google Pay. La carte bancaire n'est pas acceptée pour les dépôts. Le dépôt minimum est de 1 €, ce qui rend la plateforme accessible. Notre recommandation : configurez un virement permanent SEPA mensuel depuis votre banque vers Trade Republic, puis automatisez vos achats crypto et ETF via les Plans d'Épargne. C'est la proposition de DCA la plus simple à mettre en place du marché.",
    cryptosProse:
