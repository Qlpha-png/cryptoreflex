...
const TOPICS_MICA: SeoTopic[] = [
  {
    ...
    outline: [
      ...
      "Que faire si vous détenez encore de l'USDT en 2026",
  ...
  },
  {
    ...
    outline: [
      ...
      "Que faire si votre plateforme reste PSAN après juillet 2026",
  ...
  },
  {
    ...
    title: "MiCA et conservation : vos cryptos sont-elles vraiment protégées chez votre CASP ?",
    category: "mica",
    searchVolumeMo: 440,
    competitionLevel: "low",
  ...
  },
  {
    ...
    outline: [
      ...
      "Cas pratique : envoi 2 000 € de BTC vers votre wallet perso",
  ...
  },
  {
    ...
    title: "Passeport européen CASP 2026 : comment ça change votre choix de plateforme",
    category: "mica",
    searchVolumeMo: 290,
    competitionLevel: "low",
    cluster: "mica-statuts",
...
const TOPICS_SECURITE: SeoTopic[] = [
  ...
  },
  {
    ...
    outline: [
      ...
      "Réflexes : que faire si vous avez cliqué",
      "FAQ",
    ],
    internalLinksHints: [
