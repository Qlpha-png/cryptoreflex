...
- Méfie-toi de tout système où tes gains dépendent du recrutement de nouvelles personnes plutôt que d'une activité réelle.
...
- Avant tout dépôt, tape le nom de la plateforme sur le site de l'AMF et cherche des traces indépendantes avec le mot arnaque.
- Si tu es déjà pris, ne réinvestis surtout pas pour te refaire, documente tout, signale aux autorités et contacte vite ta banque.
</KeyTakeaways>
