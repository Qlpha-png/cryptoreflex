...
Le 3 janvier 2018, l'État du Texas émet un cease-and-desist (ordre de cessation immédiate d'activité) contre BitConnect. Deux semaines plus tard, le 17 janvier 2018, la plateforme ferme. Le token BCC s'effondre d'environ 92 % en quelques heures. Les pertes sont estimées à environ 2,4 milliards de dollars. Le fondateur Satish Kumbhani est inculpé aux États-Unis en février 2022.
...
OneCoin, lancé en 2014, est un autre Ponzi massif souvent cité. Ce projet revendiquait plusieurs millions de membres dans le monde et a détourné plus de 4 milliards de dollars selon le département de la Justice américain. Détail révélateur : OneCoin n'a jamais eu de vraie blockchain. Le token n'existait que sur des serveurs internes contrôlés par les opérateurs.
</Callout>
