...
- **Ledger ne vous contactera JAMAIS** par mail, SMS, téléphone ou Discord pour vous demander votre seed.
- **Aucun support légitime** ne vous demandera votre seed phrase. C'est la règle absolue.
- **Vérifiez toujours l'URL** avant de connecter votre wallet à un dApp (ledger.com, pas ledger-app.com).
- **Hardware wallet + 2FA TOTP** sur tous vos comptes = 95 % du risque éliminé.
- En cas d'arnaque : signalez à **Pharos** (internet-signalement.gouv.fr) et **Cybermalveillance.gouv.fr**.
</Callout>
...
| **Phishing fake support qui demande seed** | Drain si vous donnez la seed | Vous ne devriez jamais donner la seed (mais possible) |
...
Si vous détenez plus de 1 000 € en crypto et que vous n'avez pas encore de hardware wallet, c'est votre priorité numéro 1. Pour 95 % des utilisateurs, le <AffiliateLink href="https://shop.ledger.com/" platform="ledger" placement="article-phishing-cta-1">Ledger Nano X</AffiliateLink> reste le standard : 5 500+ cryptos supportées, écran sécurisé qui affiche chaque transaction à valider physiquement. Combiné à une 2FA TOTP (Authy, 2FAS) sur tous vos exchanges, vous éliminez 95 % du risque phishing résiduel. À commander **uniquement sur le site officiel** — jamais Amazon, jamais eBay.
</Callout>
...
3. **Révoquez les approvals** : utilisez [Revoke.cash](https://revoke.cash) pour annuler toutes les approvals données. Cela peut empêcher le drainer de continuer.
...
- [Sécuriser vos cryptos en 2026 : wallet, 2FA, anti-phishing](/blog/securiser-cryptos-wallet-2fa-2026) — l'article central sur la sécurité.
...
- [Configurer votre Ledger Nano X en 30 minutes](/blog/configurer-ledger-nano-x-30-minutes-guide-pas-a-pas) — le tuto pas-à-pas sécurisé.
...
- [Wallet air-gap vs Bluetooth](/blog/wallet-air-gap-vs-bluetooth-securite-2026) — choisir le bon hardware selon votre profil.

<Callout type="warning" title="Avertissement (YMYL — sécurité crypto)">
Le phishing crypto évolue **constamment**. Les techniques décrites ici (avril 2026) seront partiellement dépassées dans 12 mois — de nouvelles arnaques apparaîtront. Cryptoreflex ne fournit pas de conseil personnalisé en sécurité. Maintenez-vous informé via des sources sérieuses (ScamSniffer, Donjon Ledger, ANSSI, Cybermalveillance.gouv), restez sceptique par défaut sur toute opportunité non sollicitée, et investissez dans un hardware wallet + 2FA TOTP au minimum. La sécurité crypto est un effort continu, pas un setup unique.
</Callout>
...
<KeyTakeaways>
- Aucun support légitime ne vous demandera jamais votre seed phrase : ce réflexe à lui seul élimine une grande part du risque.
- Vérifiez chaque URL avant de connecter votre wallet et méfiez-vous des caractères trompeurs imitant un domaine officiel.
- Lisez toujours la transaction sur l'écran de votre hardware wallet : une approbation illimitée non justifiée doit vous faire annuler.
- Coupez les messages privés des inconnus sur Discord et Telegram, car le faux support y prospère.
- Restez sceptique par défaut : promesse de doubler vos cryptos, urgence artificielle ou contact spontané sont des signaux d'arnaque.
</KeyTakeaways>
