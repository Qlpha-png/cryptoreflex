...
<KeyTakeaways>
- Aucun support légitime ne te demandera jamais ta seed phrase : ce réflexe à lui seul élimine une grande part du risque.
- Vérifie chaque URL avant de connecter ton wallet et méfie-toi des caractères trompeurs imitant un domaine officiel.
- Lis toujours la transaction sur l'écran de ton hardware wallet : une approbation illimitée non justifiée doit te faire annuler.
- Coupe les messages privés des inconnus sur Discord et Telegram, car le faux support y prospère.
- Reste sceptique par défaut : promesse de doubler tes cryptos, urgence artificielle ou contact spontané sont des signaux d'arnaque.
</KeyTakeaways>
