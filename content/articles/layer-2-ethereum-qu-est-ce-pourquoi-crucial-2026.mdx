...
<KeyTakeaways>
- Retiens le principe : un Layer 2 exécute les transactions hors chaîne puis les compresse sur Ethereum, ce qui réduit fortement les frais tout en gardant la sécurité de la couche de base.
- Distingue les familles : optimistic rollups matures avec retrait lent, ZK rollups à finalité rapide, et sidechains qui n'héritent pas de la sécurité d'Ethereum.
- Pour utiliser un L2, ajoute le réseau dans ton wallet, bridge via le pont officiel, puis transige pour quelques centimes.
- Méfie-toi des risques réels : sequencer centralisé, vulnérabilité des bridges et immaturité technique de certaines solutions.
- Sache que la fiscalité française ne distingue pas L1 et L2, mais que la multiplication des transactions rend un outil de suivi quasi indispensable.
</KeyTakeaways>
