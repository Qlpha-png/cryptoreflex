...
<KeyTakeaways>
- Vérifie que chacune de tes plateformes détient bien un agrément CASP avant la bascule, sinon prépare-toi à migrer.
- Retiens la distinction clé : le PSAN était purement national, le CASP est un passeport valable dans toute l'Union.
- Privilégie les stablecoins euro conformes à MiCA plutôt que ceux délistés des plateformes régulées.
- Un transfert vers ton propre wallet n'est pas une cession imposable : garde simplement les preuves on-chain.
