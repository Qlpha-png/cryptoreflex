...
En France, les récompenses de staking sont imposables. Le régime dépend de ton niveau d'activité : ponctuel ou professionnel (BNC). Les récompenses perçues via liquid staking (stETH rebase, rETH appreciation) ont leur propre traitement fiscal.
