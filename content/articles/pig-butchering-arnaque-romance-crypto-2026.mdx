...
description: "Pig butchering : l'arnaque sentimentale crypto qui vide des comptes en semaines. Comprends les 5 phases, repère les red flags et protège-toi dès aujourd'hui."
date: "2026-05-30"
...
Si une plateforme te réclame des frais, une taxe ou une "caution" pour débloquer un retrait, tu es face à une arnaque. C'est valable sans exception. Un exchange régulé (Binance, Kraken, Coinbase) prélève ses frais directement sur le montant retiré. Il ne te demande jamais de virer de l'argent avant de te rendre le tien.
</Callout>
...
Pour aller plus loin sur les arnaques qui ciblent les investisseurs particuliers, lis notre guide sur les [schémas de Ponzi et HYIP en crypto](/blog/ponzi-hyip-crypto-schemas-pyramidaux-2026) et celui sur le [phishing crypto](/blog/phishing-crypto-2026-eviter-arnaques-courantes). Pour choisir une plateforme sûre dès le départ, consulte notre sélection des [meilleures plateformes crypto pour débutants en France](/blog/meilleure-plateforme-crypto-debutant-france-2026) et notre [comparatif](/comparatif).
...
- Repère le pattern constant : contact spontané, refus d'appel vidéo, plateforme inconnue, petits retraits qui rassurent, puis frais de déblocage.
- Retiens la règle absolue : aucun retrait légitime ne te réclame de payer une taxe ou une caution à l'avance.
- N'investis jamais sur le conseil d'une personne rencontrée en ligne, et vérifie le statut de toute plateforme sur la liste de l'AMF avant de virer le moindre euro.
- Si tu es pris au piège, coupe tout versement, parle à un proche extérieur, documente les preuves et dépose plainte sans laisser la honte te paralyser.
</KeyTakeaways>
