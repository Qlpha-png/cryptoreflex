...
**Dépose une plainte.** Auprès de la police ou de la gendarmerie, ou via la plateforme de signalement Thésée (pour les escroqueries en ligne) sur le portail officiel. Signale également la plateforme à l'AMF via Épargne Info Service (0 811 84 84 84).
