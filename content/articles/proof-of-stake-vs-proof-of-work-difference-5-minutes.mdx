...
<KeyTakeaways>
- Retiens l'idée centrale : un mécanisme de consensus décide qui a le droit d'ajouter le prochain bloc, en rendant la triche trop coûteuse.
...
- En tant qu'investisseur, le Proof of Stake t'ouvre l'accès au staking et à un rendement passif, ce que le Proof of Work ne permet pas.
- Garde en tête que le staking n'est jamais sans risque : slashing, délai de retrait et baisse du prix du token sous-jacent existent toujours.
</KeyTakeaways>
