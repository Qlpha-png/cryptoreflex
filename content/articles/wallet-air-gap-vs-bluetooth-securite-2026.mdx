...
<KeyTakeaways>
- Retiens qu'un wallet avec USB ou Bluetooth n'est pas « en ligne » : la clé privée reste dans le composant sécurisé et n'est jamais transmise.
...
- Réserve l'air-gap pur (Coldcard, SeedSigner) aux bitcoiners maximalistes, aux profils ciblés et à une paranoïa technique justifiée.
- Si tu veux durcir ton Ledger sans changer d'appareil, désactive le Bluetooth, vérifie chaque transaction sur l'écran physique et tiens le firmware à jour.
- Garde en tête qu'aucun hardware wallet n'est invulnérable : ta sécurité dépend autant de ton hygiène d'usage que du matériel, et achète toujours sur le site officiel.
</KeyTakeaways>
