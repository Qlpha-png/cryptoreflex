...
Le staking génère un rendement passif. Ça, tu le sais. Ce que la plupart des guides passent sous silence, c'est la liste des choses qui peuvent mal tourner avant que ce rendement arrive dans ton portefeuille.
...
Si tu délègues ton stake à un opérateur (staking poolé, liquid staking), c'est son infrastructure qui détermine ton exposition au slashing. Vérifie son historique opérationnel avant de choisir.
</Callout>
...
<Callout type="warning">
"Not your keys, not your coins" reste la règle d'or. Le staking sur exchange est pratique — mais tu externalises le risque vers une entité centralisée dont tu n'évalues pas le bilan quotidiennement.
</Callout>
...
- L'unbonding immobilise tes fonds pendant 1 à 5 jours sur Ethereum (jusqu'à 28 jours sur d'autres réseaux). Pendant ce temps, tu ne peux ni vendre ni déplacer ton capital — le marché, lui, peut bouger.
- Staker sur un exchange centralisé, c'est confier tes clés. En cas de faillite ou de gel (précédents Celsius, FTX, BlockFi), tes fonds peuvent être bloqués des mois sans recours.
