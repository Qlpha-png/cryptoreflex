...
<KeyTakeaways>
- Un vrai support ne te contacte jamais en premier en message privé et ne te demande jamais ta seed phrase, ta clé privée ni un code 2FA : toute demande de ce type est une arnaque.
- Le SIM-swap détourne ton numéro chez l'opérateur pour intercepter tes SMS : c'est pourquoi le 2FA par SMS est une passoire face à cette attaque.
- Remplace le SMS par une application TOTP sur chaque compte sensible, et passe à une clé physique pour les gros montants car elle résiste aussi au phishing.
- Sécurise ta ligne mobile avec un code chez ton opérateur, utilise une adresse e-mail dédiée non publique, et garde un profil bas sur tes détentions.
- Une perte soudaine de réseau mobile peut signaler un SIM-swap en cours : appelle ton opérateur immédiatement depuis une autre ligne pour bloquer l'opération.
</KeyTakeaways>
