...
<CTABox
  ...
  ctaUrl="/comparatif"
  disclosure="Méthodologie publique. Cryptoreflex est affilié commercial uniquement de Ledger, Trezor et Waltio ; les autres plateformes citées sont soit sans lien commercial, soit liées via les codes de parrainage personnels du fondateur (voir /transparence)."
/>
...
Cryptoreflex est partenaire affilié commercial de **Ledger, Trezor et Waltio** uniquement. Les liens vers **Coinbase, Binance France et Bitpanda** sont des codes de parrainage personnels du fondateur Kevin Voisin (en tant que client particulier — pas un partenariat commercial Cryptoreflex). **Kraken** est cité sans aucun lien commercial. Cette répartition n'influence ni notre méthodologie de scoring ni nos recommandations. Détail complet sur [/transparence](/transparence) et [méthodologie](/methodologie).
...
<KeyTakeaways>
- Retiens la différence de fond : le PSAN est un statut français, le CASP est un agrément européen unique avec passeport vers tous les États membres.
- Ne crois pas qu'un PSAN devient CASP automatiquement : seul le PSAN agréé bénéficie d'une procédure simplifiée, le PSAN simple doit déposer un dossier complet.
- Ne confonds pas CASP et VASP : un enregistrement VASP étranger ne vaut pas un agrément MiCA, vérifie la mention sur la base ESMA.
- Le CASP t'apporte plus de protection : ségrégation des avoirs, plan de continuité et recours facilité auprès du médiateur AMF.
- MiCA est une régulation prudentielle, pas fiscale : ta façon de déclarer tes plus-values crypto ne change pas.
</KeyTakeaways>
