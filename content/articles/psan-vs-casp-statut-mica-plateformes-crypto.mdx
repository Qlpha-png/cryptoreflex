...
excerpt: "PSAN et CASP cohabitent jusqu'au 30 juin 2026 — puis seul le statut européen CASP subsiste. On décortique les différences de périmètre, d'autorité, d'obligations et ce que ça change concrètement pour vos comptes."
category: "MiCA"
date: "2026-04-26"
...
On lit souvent que "tous les PSAN deviennent CASP automatiquement" : **c'est faux**. Seuls les PSAN agréés bénéficient d'une procédure simplifiée — et même eux doivent déposer un dossier complémentaire. Les PSAN simples (qui représentent la majorité du marché français) doivent passer par une demande CASP complète, avec frais et délais associés. Vérifiez toujours le statut effectif de votre plateforme via le [vérificateur MiCA](/outils/verificateur-mica) ou la base ESMA.
</Callout>
...
<CTABox
  variant="primary"
  title="Comparez les plateformes CASP-agréées en 1 clic"
...
<CTABox
  variant="secondary"
  title="Vérifiez le statut CASP de votre plateforme en 30 secondes"
  description="Notre vérificateur interroge en temps réel le registre ESMA et notre base interne. PSAN simple, PSAN agréé, CASP délivré ou dossier en instruction : on vous donne le statut exact, le pays d'agrément et la liste des services autorisés."
...
<KeyTakeaways>
- Retenez la différence de fond : le PSAN est un statut français, le CASP est un agrément européen unique avec passeport vers tous les États membres.
- Ne croyez pas qu'un PSAN devient CASP automatiquement : seul le PSAN agréé bénéficie d'une procédure simplifiée, le PSAN simple doit déposer un dossier complet.
- Ne confondez pas CASP et VASP : un enregistrement VASP étranger ne vaut pas un agrément MiCA, vérifiez la mention sur la base ESMA.
- Le CASP vous apporte plus de protection : ségrégation des avoirs, plan de continuité et recours facilité auprès du médiateur AMF.
- MiCA est une régulation prudentielle, pas fiscale : votre façon de déclarer vos plus-values crypto ne change pas.
</KeyTakeaways>
