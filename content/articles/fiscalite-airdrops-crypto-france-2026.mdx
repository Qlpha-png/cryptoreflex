...
<KeyTakeaways>
- La doctrine ne traite pas explicitement les airdrops : on raisonne par analogie, et le traitement change selon que ton airdrop a demandé une action active (claim) ou une simple détention passive.
...
- Si tu fais de l'airdrop hunting habituel (multi-wallets, testnets farmés, outils dédiés), le régime BNC devient difficile à éviter.
- Conserve systématiquement le hash de la transaction de claim et le cours au jour de réception : sans ces preuves, ton calcul n'est pas opposable en cas de contrôle.
- Côté formulaires, déclare la cession sur le 2086 puis le 2042, le BNC sur le 2042-C-PRO, et n'oublie pas le 3916-bis si tes tokens transitent par un compte étranger.
</KeyTakeaways>
