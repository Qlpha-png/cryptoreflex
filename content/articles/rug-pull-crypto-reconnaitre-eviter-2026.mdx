...
<KeyTakeaways>
- Sache reconnaître les variantes d'un rug pull : retrait de liquidité brutal, fonction mint cachée, honeypot qui bloque la revente, ou abandon progressif.
- Scanne systématiquement le contrat avec Honeypot.is ou Token Sniffer avant d'acheter un token inconnu.
- Vérifie que la liquidité est verrouillée et que le supply n'est pas concentré sur quelques wallets : une équipe anonyme sans audit reste un signal d'alerte majeur.
- Si tu ne peux pas réunir ces preuves rapidement, considère l'opacité elle-même comme une réponse et passe ton chemin.
</KeyTakeaways>
