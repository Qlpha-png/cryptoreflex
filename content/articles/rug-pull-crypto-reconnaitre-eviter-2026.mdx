...
Les rug pulls ne touchent pas que la finance décentralisée. Thodex, un exchange centralisé turc, a constitué un exit scam en avril 2021 : le fondateur a pris la fuite avec environ 2,6 milliards de dollars de fonds clients. La menace existe aussi sur les plateformes centralisées non régulées. C'est une raison supplémentaire d'utiliser uniquement des exchanges [disposant du statut PSAN ou MiCA en France](/blog/psan-vs-casp-statut-mica-plateformes-crypto).
</Callout>
