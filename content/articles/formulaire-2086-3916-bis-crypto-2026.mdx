...
description: "Guide complet 2026 pour déclarer vos cryptos aux impôts français. Formulaire 2086 ligne par ligne, 3916-bis pour comptes étrangers (Binance, Bitget...), flat tax 30%, exemples chiffrés, sanctions et FAQ."
date: "2026-04-25"
updated: "2026-04-25"
...
> **Notre calculateur fiscal gratuit fait ça pour vous → [/outils/calculateur-fiscalite](/outils/calculateur-fiscalite)**
> Importez vos exports CSV Binance, Coinbase, Kraken, et obtenez automatiquement le PDF prérempli du 2086 + le récapitulatif des comptes à déclarer en 3916-bis.
...
- [4. Quand devez-vous déclarer ? Le fait générateur](#4-fait-generateur)
...
> **Attention** : même si l'échange crypto → stablecoin n'est pas imposable, l'opération doit être **traçable** dans votre comptabilité personnelle pour calculer le **prix moyen pondéré (PMP)** de votre portefeuille global. Un logiciel comme [Waltio](/comparateurs/logiciels-fiscaux) ou Koinly est quasi indispensable au-delà de 50 transactions.
...
5. L'annexe **2086** s'ajoute automatiquement à votre déclaration.
...
3. Le formulaire **3916-bis** s'ajoute, et vous pouvez **cliquer sur "Ajouter un compte"** pour chaque plateforme.
...
Et surtout, **notre [calculateur fiscal gratuit](/outils/calculateur-fiscalite)** vous donne en 3 minutes une **estimation immédiate** de votre impôt (utile avant la fin d'année pour piloter vos cessions).
...
> **Notre calculateur fiscal gratuit** : si vous avez moins de 20 cessions, [/outils/calculateur-fiscalite](/outils/calculateur-fiscalite) suffit largement et reste **100 % gratuit, sans inscription**.
...
1. **Recensez TOUS vos comptes** sur exchanges étrangers (même fermés, même inactifs) → **3916-bis** par compte.
2. **Listez TOUTES vos cessions imposables** (ventes EUR, paiements en crypto) → **2086** ligne par ligne.
...
5. **Conservez 10 ans** vos exports CSV, captures et PDF de déclaration.
