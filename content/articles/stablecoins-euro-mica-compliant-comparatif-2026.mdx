...
- Côté fiscalité, un échange entre actifs numériques sans soulte (euro-stablecoin → autre crypto) n’est pas un fait générateur (sursis, art. 150 VH bis) : tu n’es imposé qu’à la cession contre euro, un bien/service (ou une soulte) ; déclare tes comptes étrangers via le formulaire 3916-bis.
</KeyTakeaways>
