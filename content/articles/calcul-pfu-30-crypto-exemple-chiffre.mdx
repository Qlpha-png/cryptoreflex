...
**Erreur 4 — ne pas reporter ses moins-values.** Si tu as fait une moins-value en 2024 sur Bitcoin, tu peux la **reporter pendant 10 ans** sur tes plus-values futures. Beaucoup oublient ce mécanisme, qui peut diviser la note fiscale par deux. Méthode complète dans [Comment déduire ses pertes crypto de l'impôt 2026](/blog/deduire-pertes-crypto-impot-2026).
