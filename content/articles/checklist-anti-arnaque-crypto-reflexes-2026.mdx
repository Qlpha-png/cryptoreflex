...
<KeyTakeaways>
- Repère le mécanisme d'entrée plutôt que chaque arnaque : promesse de rendement garanti, urgence fabriquée, contact non sollicité, confiance mise en scène ou frais à payer pour débloquer des fonds.
- Ta seed phrase et ta clé privée ne quittent jamais ton environnement sécurisé : personne de légitime ne te les demandera, sous aucun prétexte.
- Protège tes comptes avec un 2FA par application ou clé physique, garde le gros du capital sur hardware wallet, et vérifie chaque URL caractère par caractère sans cliquer les liens reçus en message.
- Ne signe jamais une transaction que tu ne comprends pas, révoque régulièrement les autorisations inutiles de ton wallet, et vérifie le statut d'une plateforme sur le registre de l'AMF avant de déposer.
- Au moindre doute, ne fais rien dans l'urgence : stoppe, cherche un avis extérieur indépendant, vérifie les sources officielles et signale si nécessaire.
</KeyTakeaways>
