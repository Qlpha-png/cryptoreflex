...
Selon les données de Group-IB, les signatures de type Permit et les approbations malveillantes sont impliquées dans environ 56,7 % des cas de grosses pertes liées aux wallet drainers. C'est le vecteur dominant — pas le vol de seed phrase.
