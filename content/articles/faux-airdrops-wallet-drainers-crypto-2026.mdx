...
<KeyTakeaways>
- Le wallet drainer ne vole pas ta seed phrase : il te fait signer une approbation de dépense ou une signature Permit qui autorise un contrat malveillant à vider ton portefeuille.
- La signature Permit est la plus piégeuse : pas de transaction, pas de frais, elle ressemble à un simple message à signer, alors lis toujours ce que ton wallet te demande d'autoriser.
...
- Utilise un wallet jetable pour les airdrops inconnus, révoque régulièrement tes approbations avec un outil dédié, et garde ton capital principal sur un hardware wallet.
- Si tu as signé, agis en quelques secondes : déplace tes actifs vers une adresse propre, révoque les autorisations, documente tout et signale l'arnaque.
</KeyTakeaways>
