...
<KeyTakeaways>
- Un hot wallet garde tes clés sur un appareil connecté (pratique, gratuit, mais exposé aux drainers, au phishing et aux faillites d'exchange) ; un cold wallet garde la clé hors-ligne, validée par bouton physique.
- Applique la règle 80/20 : garde 80 % en cold storage pour le long terme et 20 % en hot pour la DeFi et les transactions courantes.
- Dès que tu dépasses 1 000 € en crypto, ne laisse pas tout sur un exchange ; le coût d'un Ledger Nano S Plus (~80 €) est dérisoire face au risque.
- Achète ton hardware wallet uniquement sur le site officiel, jamais d'occasion ni sur une marketplace tierce, pour éviter les appareils piégés.
- Le cold wallet protège ta clé de l'extraction à distance, mais pas si tu signes une mauvaise transaction ou perds ta seed : ton hygiène anti-phishing et la sauvegarde de ta seed phrase restent décisives.
</KeyTakeaways>
