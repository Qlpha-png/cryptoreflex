...
description: "Market cap, FDV, vesting, inflation des tokens : décrypte les tokenomics d'un projet crypto avant d'investir. Guide pédago débutant-intermédiaire."
...
Un ratio FDV/Market Cap supérieur à 5 ou 10 est un signal d'alerte. Cela ne signifie pas que le projet est mauvais, mais que tu dois comprendre quand et comment les tokens restants arrivent sur le marché, et si la demande peut absorber cette offre supplémentaire.
</Callout>
...
<Callout type="info">
Des outils comme Token Unlocks (tokenomist.ai), CryptoRank ou la section "Unlocks" de CoinMarketCap permettent de visualiser les calendriers de déblocage de centaines de projets. Vérifie systématiquement ces dates avant d'entrer en position sur un altcoin.
</Callout>
...
<Callout type="tip">
Le whitepaper et les documents de tokenomics publiés par le projet (souvent sur leur site ou docs officiels) détaillent ces allocations. Si cette information n'est pas publique et accessible : fuis.
</Callout>
...
- Les calendriers de vesting et les unlocks déterminent quand les gros détenteurs (équipe, fonds) peuvent vendre. Un unlock massif crée souvent une pression baissière prévisible — vérifie les dates avant d'entrer.
