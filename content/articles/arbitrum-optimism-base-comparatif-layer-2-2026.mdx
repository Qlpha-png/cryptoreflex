...
En France, les cessions d'actifs numériques (y compris les échanges sur un DEX d'un L2) sont en principe imposables selon les règles des articles 150 VH bis et suivants du CGI. Les plus-values réalisées par des particuliers sont soumises à la flat tax de 30 % (prélèvement forfaitaire unique). Les simples transferts entre ton propre wallet L1 et ton wallet L2 ne constituent pas une cession imposable. Pour toute question fiscale précise, consulte le BOFiP ou un expert-comptable spécialisé en actifs numériques.
