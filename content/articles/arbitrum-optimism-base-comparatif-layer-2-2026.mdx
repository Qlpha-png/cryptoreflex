...
<KeyTakeaways>
- Utilise un Layer 2 pour payer des frais bien moindres et confirmer plus vite qu'en restant sur le mainnet Ethereum.
- Distingue les deux familles : les Optimistic rollups, à l'écosystème plus mature, et les ZK-rollups, à la finalité plus rapide mais encore en construction.
- Choisis selon ton profil : Base pour la simplicité, Arbitrum pour le plus grand écosystème DeFi, Optimism pour la vision décentralisée, les ZK-rollups pour explorer la technologie.
- Pour bridger, passe toujours par les bridges officiels accessibles depuis les sites des projets, jamais via un lien reçu sur Telegram ou Discord.
- Garde en tête les risques propres aux Layer 2 (bugs de smart contracts, centralisation du séquenceur, failles de bridges) et n'y places pas plus que ce que tu peux perdre.
</KeyTakeaways>
