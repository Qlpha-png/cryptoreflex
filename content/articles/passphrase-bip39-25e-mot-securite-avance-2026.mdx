...
<KeyTakeaways>
- La passphrase se combine à tes mots de récupération pour générer un wallet caché totalement séparé du wallet visible.
- Son intérêt majeur est la négation plausible face au wrench attack : tu peux exposer un wallet leurre crédible et garder l'essentiel invisible.
- Retiens le risque mortel : une passphrase oubliée ou mal orthographiée entraîne la perte définitive des fonds, même avec tes mots intacts.
- Sauvegarde ta passphrase sur un support séparé de ta seed, et teste la récupération avant d'y transférer un montant important.
- Garde un peu de fonds crédibles sur le wallet leurre : complètement vide, il alerte immédiatement un attaquant.
</KeyTakeaways>
