...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Non, l'ETN ne verse aucun coupon ni dividende. Le rendement vient uniquement de l'évolution du cours Bitcoin moins le TER annuel. Tu peux le revendre à tout moment en bourse, fiscalisé en plus-value mobilière au PFU 31,4 %."
  }
]} />
...
<KeyTakeaways>
- Il n'existe pas de vrai ETF Bitcoin spot UCITS en Europe : la directive interdit la concentration sur un seul actif, donc tu passes par des ETN physiquement répliqués accessibles depuis ton compte-titres.
- L'ETN te simplifie la vie fiscale française (un seul intermédiaire, pas de formulaire crypto dédié ni de déclaration de compte étranger) et supprime la gestion de wallet, mais tu ne possèdes pas réellement de Bitcoin.
...
- Choisis selon ton profil : ETN pour la simplicité et l'intégration patrimoniale, Bitcoin en direct pour la souveraineté des clés et l'usage en DeFi.
</KeyTakeaways>
