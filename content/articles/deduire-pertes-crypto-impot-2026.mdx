...
Tu reportes **7 000 euros en case 3AN**. Le PFU 31,4 % s'applique sur ces 7 000 euros (et non sur les 10 000 euros bruts de plus-values), soit **2 198 euros d'impôt** au lieu de 3 140 euros sans compensation. Économie : 942 euros.
...
**Stratégie 3 — fragmenter les ventes sur 2 années.** Si une grosse plus-value 2025 te ferait franchir une tranche TMI 30 %, étale sur 2025 et 2026 pour rester en TMI 11 %. Combiné avec une option case 2OP (barème progressif), peut générer plusieurs milliers d'euros d'économie. Détails : [Barème progressif ou PFU 31,4 % crypto 2026](/blog/bareme-progressif-vs-pfu-crypto-2026).
...
Le [calculateur fiscalité crypto Cryptoreflex](/outils/calculateur-fiscalite) gère la compensation intra-annuelle des moins-values. Tu rentres tes cessions de l'année, il calcule la plus-value imposable nette et le PFU 31,4 % à payer. Aucune donnée envoyée, calcul 100 % local navigateur.
</Callout>
...
<KeyTakeaways>
- Tes moins-values crypto ne se compensent qu'avec tes plus-values crypto de la MÊME année, et de façon automatique.
- Retiens la grande différence avec la bourse : pour les actifs numériques détenus par un particulier, aucun report de la moins-value sur les années suivantes : le solde négatif est définitivement perdu en fin d'année.
...
- Si tu as une grosse plus-value, applique le tax-loss harvesting avant la clôture de l'année : vends un actif en perte latente pour matérialiser la moins-value, quitte à racheter ensuite.
- Documente chaque cession (prix d'achat, prix de vente, frais) : sans preuve, la compensation peut t'être refusée en cas de contrôle.
</KeyTakeaways>
