...
description: "Capitalisation, volume 24 h, liquidité : comprends ces 3 chiffres clés avant d'investir dans une crypto. Guide pédagogique pour éviter les pièges courants."
date: "2026-05-30"
...
<Callout type="warning" title="Méfie-toi des ratios FDV/market cap élevés">
Si la FDV d'un projet est 10 fois sa market cap actuelle, cela veut dire que seulement 10 % des tokens circulent aujourd'hui. Les 90 % restants vont progressivement arriver sur le marché — et chaque déblocage est une opportunité pour les premiers détenteurs (équipe, investisseurs early) de vendre. Regarde toujours le calendrier de vesting avant d'investir dans un projet récent.
</Callout>
...
Le wash trading est une pratique où un acteur génère de faux volumes en achetant et vendant le même actif sur lui-même. Certains exchanges peu régulés sont connus pour ça. Avant de te fier au volume, vérifie que la plateforme est sérieuse et que le volume est confirmé sur plusieurs sources (CoinGecko, CoinMarketCap, Messari).
</Callout>
...
Pour approfondir ta lecture du marché dans son ensemble, consulte notre article sur la [Bitcoin dominance](/blog/bitcoin-dominance-comprendre-utiliser-2026) et notre guide sur les [cycles bull/bear crypto](/blog/cycles-marche-crypto-bull-bear-2026).
...
Prendre 5 minutes pour vérifier ces chiffres avant d'investir, c'est éviter les erreurs les plus classiques que font les débutants. Retrouve nos [outils d'analyse](/outils) pour aller plus loin, et explore notre [Académie](/academie) pour continuer à construire tes bases.
...
- Distingue offre en circulation, offre totale et offre maximale, et surveille la FDV : un gros écart avec la market cap signale un risque de dilution future.
- Un volume élevé révèle de l'activité, mais vérifie-le sur plusieurs sources pour écarter le wash trading qui gonfle artificiellement les chiffres.
- La liquidité est le vrai test du terrain : sur un marché peu liquide, le slippage te fait payer plus cher et la manipulation devient facile.
- Méfie-toi d'un float faible (tokens concentrés chez l'équipe ou les investisseurs) et lis ces indicateurs ensemble pour savoir si tu as affaire à un actif établi ou purement spéculatif.
</KeyTakeaways>
