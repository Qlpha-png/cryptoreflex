...
- Acheter un NFT avec tes ETH, c'est céder tes ETH : tu déclares une plus-value sur cette cession même sans aucune conversion en euros, et c'est l'erreur la plus fréquente des collectionneurs.
- À la revente, tu restes en plus-value de particulier si tu es occasionnel, mais tu bascules en BIC si tu revends habituellement avec une logique spéculative.
- Côté créateur, distingue le BNC artiste (œuvre originale individuelle) du BIC commerçant (collection générative en série), et garde en tête la TVA pour les NFT utility.
- Les royalties sont des revenus récurrents taxables, et tu dois conserver tes preuves de wallet et de prix pour justifier chaque opération.
</KeyTakeaways>
