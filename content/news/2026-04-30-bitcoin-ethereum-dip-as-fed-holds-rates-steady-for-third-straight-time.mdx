...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366008/bitcoin-ethereum-dip-fed-holds-rates-steady-third-straight-time"
originalTitle: "Bitcoin, Ethereum Dip as Fed Holds Rates Steady for Third Straight Time"
...
> **Source originale** : [Decrypt](https://decrypt.co/366008/bitcoin-ethereum-dip-fed-holds-rates-steady-third-straight-time) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
