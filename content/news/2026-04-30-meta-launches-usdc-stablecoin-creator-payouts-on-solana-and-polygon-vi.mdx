---
title: "Marché crypto du 30 avril — actualité SOLANA — analyse Cryptoreflex"
description: "Actualité marché crypto du 30 avril 2026 — analyse Cryptoreflex pour les investisseurs français. Source originale : Decrypt."
date: "2026-04-30"
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366087/meta-launches-usdc-stablecoin-creator-payouts-on-solana-and-polygon-via-stripe"
originalTitle: "Meta Launches USDC Stablecoin Creator Payouts on Solana and Polygon via Stripe"
...
Une actualité crypto vient d'être publiée par **Decrypt** le 30 avril 2026, classée dans la catégorie « Marché » par notre système d'analyse automatique.
...
- **Catégorie** : Marché
- **Source** : Decrypt
- **Mots-clés détectés** : solana, sol, stablecoin, usdc
...
> **Source originale** : [Decrypt](https://decrypt.co/366087/meta-launches-usdc-stablecoin-creator-payouts-on-solana-and-polygon-via-stripe) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
