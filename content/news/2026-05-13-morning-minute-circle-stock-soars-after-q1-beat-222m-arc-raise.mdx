---
title: "Morning Minute: Circle Stock Soars After Q1 Beat, $222M Arc Raise — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367530/morning-minute-circle-stock-soars-after-q1-beat-222m-arc-raise"
originalTitle: "Morning Minute: Circle Stock Soars After Q1 Beat, $222M Arc Raise"
...
> **Source originale** : [Decrypt](https://decrypt.co/367530/morning-minute-circle-stock-soars-after-q1-beat-222m-arc-raise) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
