---
title: "Marché crypto du 20 mai — actualité PLATFORM — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368309/ai-slop-floods-bug-bounty-programs-fake-reports"
originalTitle: "AI Slop Floods Bug Bounty Programs as Companies Struggle with Fake Reports"
...
> **Source originale** : [Decrypt](https://decrypt.co/368309/ai-slop-floods-bug-bounty-programs-fake-reports) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
