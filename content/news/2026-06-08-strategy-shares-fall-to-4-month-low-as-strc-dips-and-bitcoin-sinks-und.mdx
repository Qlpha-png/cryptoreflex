...
- **Bitcoin en direct** : les cessions de crypto-actifs sont également soumises au PFU de **31,4 %** dès lors que le total annuel de vos cessions dépasse 305 € (seuil d'exonération portant sur le montant des ventes, pas sur la plus-value), conformément aux règles DGFiP en vigueur.
