---
title: "Marché crypto du 3 mai — actualité STABLECOIN — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366341/moonpay-launches-debit-mastercard-ai-agents-pay-stablecoins"
originalTitle: "MoonPay Launches Debit Mastercard That Lets AI Agents Pay With Stablecoins"
...
> **Source originale** : [Decrypt](https://decrypt.co/366341/moonpay-launches-debit-mastercard-ai-agents-pay-stablecoins) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
