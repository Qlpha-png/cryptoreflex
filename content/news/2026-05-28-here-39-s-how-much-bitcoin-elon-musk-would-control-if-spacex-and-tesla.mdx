---
title: "Tendances crypto 28 mai : focus BITCOIN — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/369240/how-much-bitcoin-elon-musk-control-spacex-tesla-merge"
originalTitle: "Here&#39;s How Much Bitcoin Elon Musk Would Control If SpaceX and Tesla Merge"
...
> **Source originale** : [Decrypt](https://decrypt.co/369240/how-much-bitcoin-elon-musk-control-spacex-tesla-merge) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
