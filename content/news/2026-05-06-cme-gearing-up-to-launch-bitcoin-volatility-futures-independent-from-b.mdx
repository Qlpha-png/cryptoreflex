...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366894/cme-launch-bitcoin-volatility-futures-independent-btc-price"
originalTitle: "CME Gearing Up to Launch Bitcoin Volatility Futures Independent From BTC’s Price"
...
- **Catégorie** : Marché
- **Source** : Decrypt
- **Mots-clés détectés** : bitcoin, btc, eth
...
> **Source originale** : [Decrypt](https://decrypt.co/366894/cme-launch-bitcoin-volatility-futures-independent-btc-price) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
