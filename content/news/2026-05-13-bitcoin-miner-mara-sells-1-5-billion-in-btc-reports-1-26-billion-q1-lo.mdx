...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367650/bitcoin-miner-mara-sells-1-5-billion-btc-q1-loss"
originalTitle: "Bitcoin Miner MARA Sells $1.5 Billion in BTC, Reports $1.26 Billion Q1 Loss"
...
> **Source originale** : [Decrypt](https://decrypt.co/367650/bitcoin-miner-mara-sells-1-5-billion-btc-q1-loss) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
