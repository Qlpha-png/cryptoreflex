---
title: "Tendances crypto 12 mai : focus ETHEREUM — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367408/ethereum-firm-sharplink-686-million-loss-125m-fund-galaxy"
originalTitle: "Ethereum Firm Sharplink Posts $686 Million Loss, Kicks Off $125M Yield Fund With Galaxy"
...
> **Source originale** : [Decrypt](https://decrypt.co/367408/ethereum-firm-sharplink-686-million-loss-125m-fund-galaxy) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
