---
title: "Marché crypto du 8 mai — actualité ETHEREUM — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367192/tom-lee-bitmine-slow-ethereum-buys-12-billion-eth"
originalTitle: "Tom Lee Says BitMine May Slow Ethereum Buys After Amassing Nearly $12 Billion of ETH"
...
> **Source originale** : [Decrypt](https://decrypt.co/367192/tom-lee-bitmine-slow-ethereum-buys-12-billion-eth) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
