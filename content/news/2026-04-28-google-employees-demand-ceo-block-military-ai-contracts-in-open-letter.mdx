---
title: "Google Employees Demand CEO Block Military AI Contracts in Open Letter — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/365674/google-employees-demand-ceo-block-military-ai-contracts-in-open-letter"
originalTitle: "Google Employees Demand CEO Block Military AI Contracts in Open Letter"
...
> **Source originale** : [Decrypt](https://decrypt.co/365674/google-employees-demand-ceo-block-military-ai-contracts-in-open-letter) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
