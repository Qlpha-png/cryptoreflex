...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368875/buy-bitcoin-xrp-chatgpt-moonpay"
originalTitle: "Now You Can Buy Bitcoin, XRP and More in ChatGPT via MoonPay"
...
- **Catégorie** : Marché
- **Source** : Decrypt
- **Mots-clés détectés** : bitcoin, solana, sol
...
> **Source originale** : [Decrypt](https://decrypt.co/368875/buy-bitcoin-xrp-chatgpt-moonpay) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
