...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/292448/microstrategy-biggest-bitcoin-buys"
originalTitle: "Strategy Now Holds $65 Billion in Bitcoin—These Are Its Biggest BTC Buys"
...
> **Source originale** : [Decrypt](https://decrypt.co/292448/microstrategy-biggest-bitcoin-buys) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
