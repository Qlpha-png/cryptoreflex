---
title: "IREN Price Target Cut as Bernstein Sees Firm Dumping Bitcoin Mining for AI — analyse Cryptoreflex"
description: "Actualité marché crypto du 29 avril 2026 — analyse Cryptoreflex pour les investisseurs français. Source originale : Decrypt."
date: "2026-04-29"
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/365852/iren-price-target-cut-as-bernstein-sees-firm-dumping-bitcoin-mining-for-ai"
originalTitle: "IREN Price Target Cut as Bernstein Sees Firm Dumping Bitcoin Mining for AI"
...
Une actualité crypto vient d'être publiée par **Decrypt** le 29 avril 2026, classée dans la catégorie « Marché » par notre système d'analyse automatique.
...
> **Source originale** : [Decrypt](https://decrypt.co/365852/iren-price-target-cut-as-bernstein-sees-firm-dumping-bitcoin-mining-for-ai) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
