---
title: "Tendances crypto 20 mai : focus BITCOIN — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368347/bitcoin-giant-strategy-price-target-boost-td-cowen-2-billion-btc-buy"
originalTitle: "Bitcoin Giant Strategy Gets Price Target Boost From TD Cowen After $2 Billion BTC Buy"
...
> **Source originale** : [Decrypt](https://decrypt.co/368347/bitcoin-giant-strategy-price-target-boost-td-cowen-2-billion-btc-buy) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
