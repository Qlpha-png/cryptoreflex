---
title: "Tendances crypto 11 mai : focus ETH — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367314/elizabeth-warren-meta-stablecoin-plans-clarity-act-votes"
originalTitle: "Elizabeth Warren Wants Meta to Spill All on Stablecoin Plans Ahead of Clarity Act Votes"
...
> **Source originale** : [Decrypt](https://decrypt.co/367314/elizabeth-warren-meta-stablecoin-plans-clarity-act-votes) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
