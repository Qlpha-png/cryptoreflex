---
title: "Marché crypto du 22 mai — actualité ETHEREUM — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368694/prominent-ethereum-dev-proposes-1-billion-eth-organization"
originalTitle: "Prominent Ethereum Dev Proposes $1 Billion ETH Organization With Leader Who &#39;Wants to Fight&#39;"
...
> **Source originale** : [Decrypt](https://decrypt.co/368694/prominent-ethereum-dev-proposes-1-billion-eth-organization) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
