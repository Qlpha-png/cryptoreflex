...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/367551/bhutan-moves-8-1m-in-bitcoin-as-sell-off-continues"
originalTitle: "Bhutan Moves $8.1M in Bitcoin as Sell-Off Continues"
...
> **Source originale** : [Decrypt](https://decrypt.co/367551/bhutan-moves-8-1m-in-bitcoin-as-sell-off-continues) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
