---
title: "Marché crypto du 5 mai — actualité BITCOIN — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366624/strategy-skips-bitcoin-buy-btc-80k-first-time-since-january"
originalTitle: "Strategy Skips Bitcoin Buy as BTC Hits $80K for First Time Since January"
...
> **Source originale** : [Decrypt](https://decrypt.co/366624/strategy-skips-bitcoin-buy-btc-80k-first-time-since-january) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
