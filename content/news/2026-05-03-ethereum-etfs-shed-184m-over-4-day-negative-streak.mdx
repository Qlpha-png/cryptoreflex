---
title: "Ethereum ETFs Shed $184M Over 4-Day Negative Streak — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/366343/ethereum-etfs-shed-184m-over-4-day-negative-streak"
originalTitle: "Ethereum ETFs Shed $184M Over 4-Day Negative Streak"
...
> **Source originale** : [Decrypt](https://decrypt.co/366343/ethereum-etfs-shed-184m-over-4-day-negative-streak) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
