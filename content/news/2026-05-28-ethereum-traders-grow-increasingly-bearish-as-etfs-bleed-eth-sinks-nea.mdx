---
title: "Tendances crypto 28 mai : focus ETHEREUM — analyse Cryptoreflex"
...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/369218/ethereum-traders-increasingly-bearish-etfs-bleed-eth-sinks-near-2000"
originalTitle: "Ethereum Traders Grow Increasingly Bearish as ETFs Bleed, ETH Sinks Near $2,000"
...
- **Catégorie** : Marché
- **Source** : Decrypt
- **Mots-clés détectés** : ethereum, eth, etf
...
> **Source originale** : [Decrypt](https://decrypt.co/369218/ethereum-traders-increasingly-bearish-etfs-bleed-eth-sinks-near-2000) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
