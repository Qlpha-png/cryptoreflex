...
Rappel important : les plus-values crypto sont soumises au prélèvement forfaitaire unique (PFU) au taux de **31,4 %** (12,8 % d'impôt sur le revenu + 18,6 % de prélèvements sociaux) depuis le 1er janvier 2026 (CSG relevée par la LFSS 2026), sauf option pour le barème progressif si elle est plus favorable.
