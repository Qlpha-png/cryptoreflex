---
title: "Bitcoin, Ethereum ETFs Shed $112M as Hyperliquid Funds Extend 8-Day Win Streak — analyse Cryptoreflex"
description: "Actualité marché crypto du 27 mai 2026 — analyse Cryptoreflex pour les investisseurs français. Source originale : Decrypt."
date: "2026-05-27"
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368988/bitcoin-ethereum-etfs-shed-112m-as-hyperliquid-funds-extend-8-day-win-streak"
originalTitle: "Bitcoin, Ethereum ETFs Shed $112M as Hyperliquid Funds Extend 8-Day Win Streak"
...
Une actualité crypto vient d'être publiée par **Decrypt** le 27 mai 2026, classée dans la catégorie « Marché » par notre système d'analyse automatique.
...
> **Source originale** : [Decrypt](https://decrypt.co/368988/bitcoin-ethereum-etfs-shed-112m-as-hyperliquid-funds-extend-8-day-win-streak) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
