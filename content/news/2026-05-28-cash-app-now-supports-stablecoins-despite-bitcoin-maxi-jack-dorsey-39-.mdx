---
title: "Cash App Now Supports Stablecoins, Despite Bitcoin Maxi Jack Dorsey&#39;s &#39;Gatek... — analyse Cryptoreflex"
description: "Actualité marché crypto du 28 mai 2026 — analyse Cryptoreflex pour les investisseurs français. Source originale : Decrypt."
date: "2026-05-28"
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/369199/cash-app-supports-stablecoins-bitcoin-maxi-jack-dorsey-gatekeeper-gripes"
originalTitle: "Cash App Now Supports Stablecoins, Despite Bitcoin Maxi Jack Dorsey&#39;s &#39;Gatekeeper&#39; Gripes"
...
Une actualité crypto vient d'être publiée par **Decrypt** le 28 mai 2026, classée dans la catégorie « Marché » par notre système d'analyse automatique.
...
- **Catégorie** : Marché
- **Source** : Decrypt
- **Mots-clés détectés** : bitcoin, ethereum, eth, solana
...
> **Source originale** : [Decrypt](https://decrypt.co/369199/cash-app-supports-stablecoins-bitcoin-maxi-jack-dorsey-gatekeeper-gripes) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
