...
category: "Marché"
source: "Decrypt"
sourceUrl: "https://decrypt.co/368264/bitcoin-faces-greater-quantum-computing-risk-ethereum-citi-warns"
originalTitle: "Bitcoin Faces Greater Quantum Computing Risk Than Ethereum, Citi Warns"
...
> **Source originale** : [Decrypt](https://decrypt.co/368264/bitcoin-faces-greater-quantum-computing-risk-ethereum-citi-warns) — lien direct vers l'article publié par la source. La traduction et l'analyse française détaillée seront ajoutées prochainement (rewriter LLM en cours d'optimisation).
